...
const defaultEvents: TEvent[] = [
    {
        ...
        description: "Разработайте мини-приложение ВКонтакте и выиграйте денежный приз",
    ...
    },
    {
        ...
        description: "Карьерный форум для студентов и недавних выпускников IT-направлений",
        title: "Найти IT",
